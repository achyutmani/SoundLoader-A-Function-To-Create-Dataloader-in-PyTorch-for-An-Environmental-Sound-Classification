...
class LAEData_Train():
	def __init__(self,transform=None):
		self.annotations=np.array(pd.read_csv("TrainFile.csv"))# Read The names of Training Signals
	...
	def __getitem__(self,index):
		...
		#print(index)
		with h5py.File('LDCASE2019.hdf5', 'r') as f: # Database for Left Channel Training Spectrogram
			SG_Data = f[key][()]
